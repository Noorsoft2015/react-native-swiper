...
export default class extends Component {
  ...
  static propTypes = {
    ...
    showsLeftButton: PropTypes.bool,
    ...
    rightButtonWrapStyle: PropTypes.object,
    leftButtonWrapStle: PropTypes.object,
  }
  ...
  renderNextButton = () => {
    ...
    return (
      this.state.index !== this.state.total-1 &&
      <TouchableOpacity onPress={() => button !== null && this.scrollBy(1)} style={this.props.rightButtonWrapStyle}>
        <View>
          {button}
        </View>
      </TouchableOpacity>
  ...
  renderPrevButton = () => {
    ...
    return (
      this.state.index !== this.state.total-1 &&
      <TouchableOpacity onPress={() => button !== null && this.scrollBy(-1)} style={this.props.leftButtonWrapStyle}>
        <View>
          {button}
        </View>
      </TouchableOpacity>
  ...
  renderButtons = () => {
    return (
      <View pointerEvents='box-none' style={[styles.buttonWrapper, {
        ...
        {this.props.showsRightButton && this.renderNextButton()}
        {this.props.showsLeftButton && this.renderPrevButton()}
      </View>
    )
  }
  ...
  render () {
    ...
    return (
      <View style={[styles.container, {
        ...
        {this.renderTitle()}
        {(this.props.showsRightButton || this.props.showsLeftButton) && this.renderButtons()}
      </View>
    )
  }
}
